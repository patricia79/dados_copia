...
const { addNewPlayer, getAllPlayers, addPlayerGame, getAllGames, ranking, modifyPlayer, deletePlayerGames} = require('../controllers/player');
...
// api.get('/ranking/loser', loserPlayer) // GET /players/ranking/loser: retorna el jugador amb pitjor percentatge dՏxit
// api.get('/ranking/winner', winnerPlayer ) // GET /players/ranking/winner: retorna el jugador amb millor percentatge dՏxit
